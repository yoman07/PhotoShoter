...
public final class GraphObjectFactoryTests extends AndroidTestCase {
    ...
    public void testSetNestedObject() {
        ...
        object.setNestedObjectByUrl("http://www.photoshoter.com");

        nestedObject = object.getNestedObject();
        assertNotNull(nestedObject);
        assertEquals("http://www.photoshoter.com", nestedObject.getUrl());
    ...
    public void testSetNestedObjects() {
        ...
        object.setNestedObjectsByUrl(Arrays.asList("http://www.photoshoter.com/1", "http://www.photoshoter.com/2"));

        nestedObjects = object.getNestedObjects();
        assertNotNull(nestedObjects);
        assertEquals("http://www.photoshoter.com/1", nestedObjects.get(0).getUrl());
        assertEquals("http://www.photoshoter.com/2", nestedObjects.get(1).getUrl());
    }
