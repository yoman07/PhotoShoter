...
public final class OpenGraphObjectTests extends AndroidTestCase {
    private static String OBJECT_JSON = "{" +
            "  \"id\": \"509\"," +
            "  \"url\": \"http://www.photoshoter.com/100\"," +
            "  \"type\": \"awesome:thing\"," +
            "  \"title\": \"awesome title\"," +
            "  \"data\": {" +
            "    \"color\": \"blue\"" +
            ...
            "  \"image\": [" +
            "    {" +
            "      \"url\": \"http://www.photoshoter.com/images/81\"" +
            "    }" +
            "  ]," +
            "  \"video\": [" +
            "    {" +
            "      \"url\": \"http://www.photoshoter.com/videos/18\"" +
            "    }" +
            "  ]," +
            "  \"audio\": [" +
            "    {" +
            "      \"url\": \"http://www.photoshoter.com/audio/98\"" +
            "    }" +
            "  ]," +
            "  \"description\": \"a description\"," +
            "  \"see_also\": [" +
            "    \"http://www.photoshoter.com/101\"" +
            "  ]," +
    ...
    public void testParsedUrl() throws JSONException {
        OpenGraphObject parsedObject = getParsedObject();
        assertEquals("http://www.photoshoter.com/100", parsedObject.getUrl());
    }
    ...
    public void testParsedImage() throws JSONException {
        ...
        assertEquals("http://www.photoshoter.com/images/81", images.get(0).getProperty("url"));
    }
    ...
    public void testParsedVideo() throws JSONException {
        ...
        assertEquals("http://www.photoshoter.com/videos/18", videos.get(0).getProperty("url"));
    }
    ...
    public void testParsedAudio() throws JSONException {
        ...
        assertEquals("http://www.photoshoter.com/audio/98", audios.get(0).getProperty("url"));
    }
    ...
    public void testParsedSeeAlso() throws JSONException {
        OpenGraphObject parsedObject = getParsedObject();
        assertEquals("http://www.photoshoter.com/101", parsedObject.getSeeAlso().get(0));
    }
    ...
    public void testSetImagesByUrl() throws JSONException {
        ...
        object.setImageUrls(Arrays.asList("http://www.photoshoter.com/1", "http://www.photoshoter.com/2"));

        GraphObjectList<GraphObject> images = object.getImage();
        assertNotNull(images);
        assertEquals(2, images.size());
        assertEquals("http://www.photoshoter.com/1", images.get(0).getProperty("url"));
        assertEquals("http://www.photoshoter.com/2", images.get(1).getProperty("url"));
    }
}
